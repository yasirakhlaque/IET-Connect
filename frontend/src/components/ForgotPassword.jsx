    ...
    return (
        <div className={`flex h-screen w-screen justify-center items-center ${theme === "dark"
            ...
            <div className={`hidden md:flex flex-col justify-center items-center gap-8 w-1/2 h-full relative overflow-hidden px-12 ${theme === "dark" ? "text-white" : "text-gray-900"
                ...
                {theme === "dark" && (
                    <div className="absolute inset-0 bg-gradient-to-br from-teal-600/20 via-blue-600/10 to-transparent" />
                )}
            ...
            <div className="flex justify-center items-center md:w-1/2 h-full w-full">
                <div className={`rounded-[2rem] border p-8 md:w-96 relative shadow-2xl w-[90vw] ${theme === "dark"
                    ...
                    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-[#0FB8AD] to-[#0FB8AD]/80 text-white rounded-full h-20 w-20 flex items-center justify-center shadow-lg">
...

                    {
                        otpPage ? <OTPForm email={email} theme={theme} /> : (
                            <form className="flex flex-col gap-4 mt-6" onSubmit={handleSubmit}>
                                <div className={`flex items-center border rounded-lg px-3 py-2 focus-within:border-teal-400 transition ${
                                    theme === "dark"
                                ...
                                <button 
                                    type="submit" 
                                    disabled={sending}
                                    className={`text-xs md:text-sm bg-gradient-to-r from-[#0FB8AD] to-[#0FB8AD]/80 text-white py-2.5 rounded-lg font-semibold hover:shadow-[#0FB8AD]/30 transition shadow-lg w-full mt-4 ${sending ? 'opacity-50 cursor-not-allowed' : ''}`}
                                >
    ...
    return showResetForm ? <ForgotPasswordForm email={email} resetCode={otp} theme={theme} /> : (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-6">
            ...
            <button 
                ...
                className={`text-xs md:text-sm bg-gradient-to-r from-[#0FB8AD] to-[#0FB8AD]/80 text-white py-2.5 rounded-lg font-semibold hover:shadow-[#0FB8AD]/30 transition shadow-lg w-full mt-4 ${(verifying || otp.length !== 6) ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-6">
            ...
            <button 
                type="submit" 
                disabled={resetting}
                className={`text-xs md:text-sm bg-gradient-to-r from-[#0FB8AD] to-[#0FB8AD]/80 text-white py-2.5 rounded-lg font-semibold hover:shadow-[#0FB8AD]/30 transition shadow-lg w-full mt-4 ${resetting ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
