...
export default function SubjectCard({ subject, index }) {
    ...
    return (
        <div className={`border ${theme === "light" ? "border-gray-400" : "border-gray-700"} rounded-lg shadow-md p-4 flex flex-col gap-2 justify-between hover:scale-105 transition-transform`}>
            <div>
